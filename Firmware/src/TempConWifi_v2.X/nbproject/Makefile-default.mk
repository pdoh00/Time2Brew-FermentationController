...
SOURCEFILES_QUOTED_IF_SPACED=I2C.c OneWire.c rtc.c ESP8266.c uPnP.c mDNS.c FIFO.c circularPrintF.c Base64.c MD5.c pack.c fletcherChecksum.c GOTHtraps.c geterrorloc.s FlashFS.c PID.c Http_API.c Settings.c SystemConfiguration.c http_server.c main.c TemperatureControler.c
...
# Source Files
SOURCEFILES=I2C.c OneWire.c rtc.c ESP8266.c uPnP.c mDNS.c FIFO.c circularPrintF.c Base64.c MD5.c pack.c fletcherChecksum.c GOTHtraps.c geterrorloc.s FlashFS.c PID.c Http_API.c Settings.c SystemConfiguration.c http_server.c main.c TemperatureControler.c
