...
#define SECTORCOUNT   3975
#define FIRMWARE_BLOCK_ADDRESS 16285696UL
#define FIRMWARE_BACKUP_BLOCK_ADDRESS 16531456UL
#define FIRMWARE_SIZE 80896UL
...
#define DELAY_10uS asm volatile ("REPEAT, #630"); Nop(); // 10uS delay
#define DELAY_40uS asm volatile ("REPEAT, #2520"); Nop(); // 10uS delay
#define DELAY_5uS asm volatile ("REPEAT, #315"); Nop(); // 10uS delay
...
#define SET_WIFI_POWER(x)   (WIFI_POWER_LAT=x)
...
#define GET_CFG_MODE      !CFG_MODE_LAT
